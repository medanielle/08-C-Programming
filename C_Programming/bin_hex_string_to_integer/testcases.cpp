...
{   	                
	...
	ASSERT_EQ(ERROR_INVALID_PARAMETER, bin_hex_StrToInt32(stringlist[0]));
	ASSERT_EQ(ERROR_INVALID_PARAMETER, bin_hex_StrToInt32(stringlist[1]));
	ASSERT_EQ(ERROR_INVALID_PARAMETER, bin_hex_StrToInt32(stringlist[2]));
	ASSERT_EQ(ERROR_INVALID_PARAMETER, bin_hex_StrToInt32(stringlist[3]));
	ASSERT_EQ(ERROR_INVALID_PARAMETER, bin_hex_StrToInt32(stringlist[4]));
	ASSERT_EQ(ERROR_INVALID_PARAMETER, bin_hex_StrToInt32(stringlist[5]));
	ASSERT_EQ(ERROR_INVALID_PARAMETER, bin_hex_StrToInt32(stringlist[6]));
	ASSERT_EQ(ERROR_INVALID_PARAMETER, bin_hex_StrToInt32(stringlist[7]));
	ASSERT_EQ(ERROR_INVALID_PARAMETER, bin_hex_StrToInt32(stringlist[8]));
	ASSERT_EQ(ERROR_INVALID_PARAMETER, bin_hex_StrToInt32(stringlist[9]));
