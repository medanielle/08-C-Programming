...
/*
Practical Problem: the above solution is only good for searching: integers
Our ultimate goal: write ONE function that searches ANY type of data by ANY criteria
Binary Search
...
int testbin_recur(int argc, char **argv){
...
int testbin_iter(int argc, char **argv){
